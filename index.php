<html>
   ...
   <h3>CRUD dengan PHP MySQL</h3>
    ...
    <input type="varchar" name="no_polisi" placeholder="No Polisi">
    <input type="varchar" name="tipe_motor" placeholder="Tipe Motor">
      ...
      <table>
         ...
         <tbody>
            <tr>
               ...
               <td><a href="update.php?no_polisi=<?php echo $row['no_polisi'] ?>">Update</a></td>
               <td><a href="delete.php?no_polisi=<?php echo $row['no_polisi'] ?>"
